...
from .views import ProductList, ProductDetail, ShoppingCart, CheckoutPage, CheckoutSuccessPage, PaymentPage, add_to_cart, delete_from_cart, contact_form, shipping_form
...
urlpatterns = [
    ...
    path('checkout-success/', CheckoutSuccessPage.as_view(), name='checkout-success'),
